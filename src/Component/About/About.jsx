...
export default function About() {
  ...
  return (
    <div className="pt-15 px-4 bg-[url('../../../public/bg2.png')] sm:bg-[url('../../../public/bg1.png')] bg-cover bg-center">
            ...
            <div className="flex flex-col items-center lg:items-start gap-10">
              <div className="flex flex-col gap-6 text-center lg:text-start">
                ...
                >
                  ...
                  نابعة من فهم عميق لاحتياجات عملائنا، وحرص دائم على تقديم حلول
                  فعالة ومخصصة تُسهم في رفع كفاءة أعمالهم. نؤمن أن النجاح لا
                  يُبنى وحدنا، بل بصناعة علاقات متينة قائمة على الثقة
                  والاحترافية والاستمرارية. ومن خلال فرقنا المتخصصة وخبراتنا
                  المتراكمة، نسعى دائماً لتقديم قيمة مضافة حقيقية، تُمكّن
                  عملاءنا من التركيز على أهدافهم، بينما نتولى نحن دعمهم بكفاءة،
                  في كل خطوة من خطواتهم نحو النمو والتميّز.
                </p>
              </div>
              <div
                data-aos="fade-up"
