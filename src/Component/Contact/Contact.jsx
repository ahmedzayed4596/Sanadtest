            ...
            <div className="p-5 space-y-3 ">
              ...
              <div className="grid gap-3 grid-cols-1 text-center sm:grid-cols-2">
                <div className="col-span-2 sm:col-span-1 cart border-2 border-[#fac337] rounded-lg hover:bg-gray-400 duration-300 transition shadow-xl p-4">
                  <h3 className="flex gap-2 items-center text-[#f0bb35] text-lg font-bold">
                    {" "}
                    <svg
                      width="20px"
                      height="20px"
              ...
              <form className="max-w-md mx-auto mt-5 px-3">
                ...
                >
                  <textarea
                    ...
                    type="text"
                    id="floating_standard"
                    className="block ps-2 py-2.5 pl-16 pr-0 w-full text-sm text-white bg-transparent border-2 border-gray-300 appearance-none focus:outline-none rounded-lg focus:ring-0 focus:border-[#fac337] peer"
                    placeholder="رسالتك"
                  />
                </div>
